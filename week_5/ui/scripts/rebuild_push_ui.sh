...
UI_DIR="$ROOT_DIR/week_5/ui"
KUSTOMIZATION_FILE="$ROOT_DIR/week_5/manifests/kustomization.yaml"

IMAGE_REPO="registry.onstackit.cloud/level-3-paas/paas-ui"
TAG=""
...
Build and push the week_5 UI image.
...
Options:
  ...
  -u, --update-kustomize    Update week_5/manifests/kustomization.yaml newTag to pushed tag
  -h, --help                Show this help

Examples:
  $(basename "$0")
  $(basename "$0") --tag v5
  $(basename "$0") --container-cli podman --tag v5
  $(basename "$0") --tag v5 --update-kustomize
USAGE
}
...
echo "Building $IMAGE"
"$CONTAINER_CLI" build -t "$IMAGE" "$UI_DIR"
